...
import com.pegalite.popups.databinding.SuccessDialogBinding;
import com.pegalite.popups.listeners.PegaAnimationEndListener;

public class PegaSuccessDialog {
    private final Activity context;
    private final DialogData dialogData;
    Dialog dialog;
    SuccessDialogBinding binding;

    public PegaSuccessDialog(Activity context, DialogData dialogData) {
    ...
    public void show(PegaAnimationEndListener listener) {
        ...
        binding = SuccessDialogBinding.inflate(context.getLayoutInflater());
