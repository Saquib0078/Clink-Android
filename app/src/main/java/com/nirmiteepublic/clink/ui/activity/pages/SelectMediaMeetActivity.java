...
import com.nirmiteepublic.clink.adapters.MeetImageAdapter;
import com.nirmiteepublic.clink.databinding.ActivitySelectMediaBinding;
import com.nirmiteepublic.clink.databinding.ActivitySelectMediaMeetBinding;
...
public class SelectMediaMeetActivity extends PegaAppCompatActivity {

    public static final int REQUEST_CODE_PUBLISH_MEET = 103;
    ...
    ActivitySelectMediaMeetBinding binding;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySelectMediaMeetBinding.inflate(getLayoutInflater());
...
//        thread.start();
    ...
    private void loadMedia() {
        if (checkMediaPermission()) {
            ...
            runOnUiThread(() -> {
                ...
                MeetImageAdapter adapter = new MeetImageAdapter(mediaItems);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PUBLISH_MEET && data != null) {
