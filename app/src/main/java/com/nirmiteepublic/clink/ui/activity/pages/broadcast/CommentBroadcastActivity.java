...
import com.nirmiteepublic.clink.databinding.ActivityCommentBroadcastBinding;
...
public class CommentBroadcastActivity extends PegaAppCompatActivity {

    ActivityCommentBroadcastBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCommentBroadcastBinding.inflate(getLayoutInflater());
        ...
        replyCallbackListener = (position, name, commentID) -> {
            ...
            try {
                ...
                commentObject.put("broadcastID", broadcastID);
        ...
        commentsAdapter = new CommentsAdapter(commentModelList, broadcastID, replyCallbackListener, commentDeleteCallbackListener);
    ...
    private void addReply(JSONObject commentData) throws JSONException {
        ...
        RetrofitClient.getInstance(this).getApiInterfaces().replyCommentBroadcast(requestBody).enqueue(new PegaResponseManager(new PegaCallback(this, false) {
            @Override
    ...
    private void addComment(JSONObject commentData) {
        ...
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json"), commentData.toString());
        RetrofitClient.getInstance(this).getApiInterfaces().commentBroadcast(requestBody).enqueue(new PegaResponseManager(new PegaCallback(this, false) {
            @Override
            public void onResponse() {
                binding.post.setText("Post");
            }
    ...
    private void loadComments() {
        RetrofitClient.getInstance(this).getApiInterfaces().getBroadcastComments(broadcastID, 0).enqueue(new PegaResponseManager(new PegaCallback(this, false) {
            @Override
            public void onSuccess(@Nullable JSONObject... data) {
    ...
    private void loadMoreComments() {
        ...
        RetrofitClient.getInstance(this).getApiInterfaces().getBroadcastComments(broadcastID, size).enqueue(new PegaResponseManager(new PegaCallback(this, false) {
            @Override
            public void onSuccess(@Nullable JSONObject... data) {
