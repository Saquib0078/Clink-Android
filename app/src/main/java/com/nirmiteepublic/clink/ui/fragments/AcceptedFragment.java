...
import com.nirmiteepublic.clink.databinding.FragmentAcceptedBinding;
...
public class AcceptedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       RetrofitClient.getInstance(requireContext()).getApiInterfaces().getUserAccepted().enqueue(new Callback<Response>() {
           @Override
