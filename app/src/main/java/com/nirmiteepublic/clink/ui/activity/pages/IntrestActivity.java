...
import com.nirmiteepublic.clink.databinding.ActivityIntrestBinding;
...
ActivityIntrestBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding=ActivityIntrestBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        ArrayList<String> itemList = readAndParseJsonFile("INTERESTS.json");
        ...
        binding.listViewDistrict.setOnItemClickListener((parent, view, position, id) -> {
            String selectedIntrest = adapter.getItem(position);
