...
public class ApiManager {
    ...
    public static void getLiveMeetings(Context context, final VolleyCallback callback) {
    ...
    public static void getTask(Context context, final VolleyCallback callback) {
...
//            @Override
//            public Map<String, String> getHeaders() throws AuthFailureError {
//                // Add JWT token to the request headers for verification
//                Map<String, String> headers = new HashMap<>();
