...
public class MediaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (mediaModelList.get(viewType).getMimeType().startsWith("image")) {
            return new ItemMediaImageViewHolder(ItemMediaImageBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false), parent.getContext(), mediaModelList.get(viewType));
        }
        return new ItemMediaVideoViewHolder(ItemMediaImageBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false), parent.getContext(), mediaModelList.get(viewType));
    }
